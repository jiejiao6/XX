...
public class LuaTimerTask extends TimerTaskX {
	...
	public LuaTimerTask(LuaContext luaContext, String src, Object[] arg)
			throws LuaException {
	...
	public LuaTimerTask(LuaContext luaContext, LuaObject func)
			throws LuaException {
		this(luaContext, func, null);
	}

	public LuaTimerTask(LuaContext luaContext, LuaObject func, Object[] arg)
			throws LuaException {
	...
	public void setArg(LuaObject arg) throws ArrayIndexOutOfBoundsException,
			LuaException, IllegalArgumentException {
		mArg = arg.asArray();
	}
	...
	public void doAsset(String name, Object... args) throws LuaException,
			IOException {
		int ok = 0;
