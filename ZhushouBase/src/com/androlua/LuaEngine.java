 ...
 *
 */
public class LuaEngine implements LuaBroadcastReceiver.OnReceiveListerer,
		LuaContext {
	...
	private LuaEngine() {
		...
		luaLpath = (luaDir + "/?.lua;" + luaDir + "/lua/?.lua;" + luaDir + "/?/init.lua;")
				+ luaLpath;
	 ...
	 *             当有错误发生时抛出的异常
	 */
	public String evalLua(String script, Map<Object, Object> args)
			throws LuaException {
		L.setTop(0);
	 ...
	 *            要执行的脚本命令
	 * @param args
	 *            脚本执行需要的参数 MapHashMap<Object, Object> args = new
	 *            HashMap<Object, Object>(); args.put("name", "joshua");
	 *            args.put("password", "123456"); args.put("url",
	 *            "https://taobao.com");
	 * @return
	 */
	public String execLuaStatemanet(String statemanet, Map<Object, Object> args) {
		...
		stringBuffer.append("rootShell.simulateBroadcast(\""
				+ BroadcastType.ShellExecStart.getValue() + "\", \"\")\n");
		...
		stringBuffer.append("rootShell.simulateBroadcast(\""
				+ BroadcastType.ShellExecFinish.getValue() + "\", \"\")\n");
	 ...
	 * @return
	 */
	public String execLuaScriptFile(String filePathString,
	...
	public DexClassLoader loadDex(String path) throws LuaException {
		...
		if (path.endsWith(".jar"))
			loadResources(path);
		dex = new LuaDexClassLoader(path, odexDir, LuaApplication
				.getContextObject().getApplicationInfo().nativeLibraryDir,
				LuaApplication.getContextObject().getClassLoader());
	...
	private static class LuaDexClassLoader extends DexClassLoader {
		...
		public LuaDexClassLoader(java.lang.String dexPath,
				java.lang.String optimizedDirectory,
				java.lang.String libraryPath, java.lang.ClassLoader parent) {
